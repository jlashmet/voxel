...
- Latest accepted code gate: `40007bc9e7ae074223bef71619c1e070a38a7d54` — 386 tests, 373 passed, exactly the same 13 known baseline failures. CharacterMotor API run `31896455076` accepts replacement of direct `VoxelAccess`/physical Storage reads with the existing Storage.Api `IVoxelSurfaceQuery` capability.
