...
- Latest accepted code gate: `ab2d1ca4323cc9fd6bdbee814007b716de76c5cd` — 386 tests, 373 passed, exactly the same 13 known baseline failures. Showcase catalogue API run `31897445992` accepts removal of the stale Structures.Runtime dependency; `ShowcaseCatalogue` now consumes `Structures.Api` only.
