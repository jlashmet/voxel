...
- Latest accepted code gate: `a4f80c5d96397e6de64720c3b3608b6e81fb27a5` — 386 tests, 373 passed, exactly the same 13 known baseline failures. Tools shell removal run `31896191600` accepts deletion of the source-empty `VoxelEngine.Tools` / `VoxelEngine.Tools.Features` assemblies after proving no foreign asmdef references remained.
