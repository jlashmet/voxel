    ...
    public static class KentridgeUrbanCirculation
    {
        ...
        public static KentridgeUrbanCirculationPlan Build(uint seed)
        {
            ...
            var connectors = new List<KentridgeUrbanConnector>(4)
            {
                ...
                new KentridgeUrbanConnector("lower-west-stair-street", KentridgeUrbanConnectorKind.StairStreet, KentridgeUrbanBand.LowerWard, new Int2(LowerWestStairXDm, LowerWestStairSouthZDm), new Int2(LowerWestStairXDm, LowerWestStairNorthZDm), LowerWestStairWidthDm),
