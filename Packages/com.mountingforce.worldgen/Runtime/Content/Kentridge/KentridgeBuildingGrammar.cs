...
namespace MountingForce.WorldGen.Content.Kentridge
{
    ...
    /// <summary>
    /// Renderer-independent result of the per-building grammar. The planner owns where a stable
    /// gameplay role lives; this form owns architectural choices inside that role's plot envelope.
    /// </summary>
