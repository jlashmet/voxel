...
## Fix / regression
Keep actor roots unchanged; reconcile only Kentridge visual-child offsets to current enabled renderer minima in `LateUpdate`, after animation. Release gameplay coordinates are unchanged.
...
Final source `3768f011b2d80069c8783694ae1c8179e6f6c4b9`; exact request `13b39e1c23d20c59375fe2e0d2221d28f64252b4`, run `33120343242`: success. Runtime deltas: Weldon 0.000 m, Madeline 0.000 m, Steven 0.000 m. Replay evidence is `verification-final.jpg` at canonical 771x334 / quality 40 plus direct 40%-scale detail crops for foot contact.
