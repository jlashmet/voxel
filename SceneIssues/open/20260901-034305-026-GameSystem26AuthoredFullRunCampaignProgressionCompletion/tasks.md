...
- [ ] **T26-043 — Verify shared multiplayer progression/outcome.** **BLOCKED external prerequisite:** `origin/master` still lacks System25's shared separate-process harness and production Kentridge multiplayer runtime. Latest observed System25 feature head `b96394d496a1b4e292945614b880c9ff429fbf35` has isolated the prior combat-turn/survivability root cause, but T25-010E and the final authority/client topology, gameplay, reconnect/current-state, explicit leave, capacity/JIP/reconnect/rehost and separate-process evidence remain unchecked; its CI transport still points at failed request `89cf8233aa0739ce25a0904eb2756d2417475e32`. Do not duplicate that infrastructure or campaign authority in System26. After System25 is validated, closed and merged, add the narrow System26 consumer that proves authority and separate clients converge on shared Progression and the same immutable terminal GameOutcome.
