...
- [ ] **T26-053 — Run automatic domain/campaign tests plus built-player full-run gate.** Campaign and fresh-graph restore regressions passed exact-SHA run `33941421358`; a new exact-SHA run is required for the Story-owned validation tree. Built-player full-run and shared multiplayer portions remain blocked by T26-043/T26-044.
