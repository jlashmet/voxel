...
- [ ] **T26-053 — Run automatic domain/campaign tests plus built-player full-run gate.** Campaign and fresh-graph restore regressions passed exact-SHA run `33941421358`; the Story-owned validation tree and current production/test tree passed exact-SHA run `33942377377` for feature SHA `14de8c30549f6c696c3ad671c30cfb513eca5bb2`. Built-player full-run and shared multiplayer portions remain blocked by T26-043/T26-044.
