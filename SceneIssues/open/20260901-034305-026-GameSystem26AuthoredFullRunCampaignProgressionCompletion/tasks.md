...
- [ ] **T26-043 — Verify shared multiplayer progression/outcome.** **BLOCKED external prerequisite:** System25 remains open on current master. Its branch `fixes/agent-7` is `b2d1847ec109eb8be7a631c084bd60230c5932a2`; exact-current harness request `382b9c33a2f4edabd7bf46c598e1ee1d9eea0291` run `33986100313` is queued and must not be replaced. System25 still depends on System24. System24 remains at `fixes/agent-2` `f6b3ace316f7122b48135ea04c0f04078049d9a5`; request `64296df9f805d2690942d5f302e07a32f3a8b823` run `33984774287` is retry attempt 2 and queued. Reuse System25 infrastructure only after those production prerequisites land; do not create an alternate transport/process harness.
- [ ] **T26-044 — Add canonical built-player full-run scenario.** **BLOCKED external prerequisite:** current Kentridge physical planner intentionally accepts one Kentridge region, while `20260829-020634-000-KentridgeMacroWorldPhysicalRealization` remains open. Renderer-owner exact-current request `416400b334fbac3561a6e790723d99328954e12e` for feature `7ceaa0120a4e30c260b1f383e7fc973c3c205309` is queued as run `33986630571`; do not replace it. Until that renderer correction validates, lands, and macro-world completes its native built-player proof, do not weaken the single-region invariant or fake later regions.
