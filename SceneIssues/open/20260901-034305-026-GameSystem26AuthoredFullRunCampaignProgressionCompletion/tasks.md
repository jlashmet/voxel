...
- [ ] **T26-043 — Verify shared multiplayer progression/outcome.** **BLOCKED external prerequisite:** System25 remains open on current master. Its branch `fixes/agent-7` is `b2d1847ec109eb8be7a631c084bd60230c5932a2` with independent stale-milestone/relaunch-state harness fixes, but exact request `fa5bfd1c902d7832298690e874621a80a2271b01` run `33984593462` completed `cancelled` and System25 still depends on System24. System24 `fixes/agent-2` is `f6b3ace316f7122b48135ea04c0f04078049d9a5` and now authors the canonical production vertical-slice scenario, but exact request `64296df9f805d2690942d5f302e07a32f3a8b823` run `33984774287` completed `cancelled`; the production boundary is therefore not accepted/landed. Reuse System25 infrastructure only after those prerequisites land; do not create an alternate transport/process harness.
- [ ] **T26-044 — Add canonical built-player full-run scenario.** **BLOCKED external prerequisite:** current Kentridge physical planner intentionally accepts one Kentridge region, while `20260829-020634-000-KentridgeMacroWorldPhysicalRealization` remains open at `fixes/agent-6` `7142ae97de62486fd932fbdc4c9f323b9eade24e`. Its separately owned renderer correction is not on master and the latest observed renderer exact run `33984671790` completed `cancelled`. Do not weaken the single-region invariant or fake later regions.
