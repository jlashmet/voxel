...
- [ ] **T26-043 — Verify shared multiplayer progression/outcome.** **BLOCKED external prerequisite:** System24 owner candidate `e724343d0f2a2d05631e1305f344ba94f832e94f` has directly-parented exact request `21f11d63a8785556562931b7c7a279b4f9bae266`; run `33995706164` is queued. Leave it untouched. System25 master-sync source `94ab660260d9b066f030f702500aba092b321a98` passed run `33992072202`; corrected diagnostic source `5c1256867bcc07278049595d171abf22e2bd1a33` passed directly-parented request `4fdb3400ef72c2095adcba6353f09c70724dd81a` in run `33995470352`. The diagnostic seam is therefore green, but real authority + two-client gameplay, shared progression, reconnect/recovery, and closure still require System24 to validate and land. Reuse System25 infrastructure only after that boundary is available; do not create an alternate transport/process harness.
- [ ] **T26-044 — Add canonical built-player full-run scenario.** **BLOCKED external prerequisite:** current Kentridge physical planner intentionally accepts one Kentridge region, while `20260829-020634-000-KentridgeMacroWorldPhysicalRealization` remains open on authoritative master. Macro-world is at `6278be0371ca04205ac072ad114745a2a882c009`. Renderer exact source `fc767620a0fe5d0dfee204947d13e7eefaa2a3fa`, request `8e6aac9fe8845a04a0bdfca2640fc11988e50506`, run `33996360570` is queued and must be left untouched. Until renderer acceptance validates and lands, and macro-world completes its native built-player proof, do not weaken the single-region invariant or fake later regions.
