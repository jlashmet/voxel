...
- [ ] **T26-043 — Verify shared multiplayer progression/outcome.** **BLOCKED external prerequisite:** System25 current exact candidate `1727641603ba4645a798b3ca246bc8d9130afb95` passed directly-parented request `06585b896b23c38a7c929dd3294211c68ca494a2` in run `33987833161`, proving its current harness/attribution work. Real authority + two-client topology, shared progression, reconnect/recovery, and closure remain unchecked on System25 and still require System24's production composed built-player boundary. System24 has advanced to corrected feature `d0971511dee5affc0064adcc83f6c2e9d7b7b050`; exact request `a344880385e357aa0a7cef83a5aeb5b1a59a51d5` is directly parented by it and run `33988814815` is queued. Do not replace/interfere with that run. Reuse System25 infrastructure only after System24 validates and lands; do not create an alternate transport/process harness.
- [ ] **T26-044 — Add canonical built-player full-run scenario.** **BLOCKED external prerequisite:** current Kentridge physical planner intentionally accepts one Kentridge region, while `20260829-020634-000-KentridgeMacroWorldPhysicalRealization` remains open on authoritative master. Macro branch `52cb1314d179c5a4e84fd40234024d8beca0cdb3` classifies renderer run `33987770257` as CPU compile/runtime-success but validation/visual-red due repeated input tests and the persistent gray far-world slab. Until renderer acceptance validates, lands, and macro-world completes its native built-player proof, do not weaken the single-region invariant or fake later regions.
