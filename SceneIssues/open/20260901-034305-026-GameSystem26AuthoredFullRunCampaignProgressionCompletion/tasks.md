...
- [ ] **T26-043 — Verify shared multiplayer progression/outcome.** **BLOCKED external prerequisite:** current System25 source `6401622dab168f474aa2abc19eb8828e36cbaa07` still leaves its production authority/client topology, baseline convergence, contention/conservation, combat/vitality, shared progression, reconnect/current-state recovery, explicit leave, rehost and final separate-process evidence unchecked. Do not create an alternate System26 transport/process harness or duplicate campaign authority in clients.
