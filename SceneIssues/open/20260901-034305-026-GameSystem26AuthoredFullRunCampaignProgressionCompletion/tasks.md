...
- [ ] **T26-059 — Add WorldBuilder-owned top-down physical-world built-player validation.** WorldBuilder's player-visible macro planner/reservation/terrain/roads/towns/water realization was affected, while its existing `Validation/SecretDiscovery` scene does not exercise that path. `Assets/Game/WorldBuilder/Validation/TopDownPhysicalWorld/` uses the production physical planner, reservation adapter, voxel/water catalogues, `ShowcaseWorld`, streaming and rendering composition with semantic Moordell/Rossdam/water milestones. Exact request `7d5ee6f751e0d4d72d3061b9a4474703921a5d58` / run `34170036879` automatically discovered this target, then compile failed only on a nonexistent validation readiness call and missing direct `VoxelEngine.Storage.Api`; both boundary defects are repaired using `ShowcaseWorld.IsGenerated` plus production published-coverage readiness and an explicit asmdef reference. Keep unchecked until exact standalone-player PASS.
...
- [ ] **T26-053 — Run automatic domain/campaign tests plus built-player full-run gate.** Request `3796acf10f04fe266413f0956ebbd59e954336ad` / run `34164164923` exposed and led to repair of stale `AuthoredTownPlan.BackendPlan` test usage. Request `7d5ee6f751e0d4d72d3061b9a4474703921a5d58`, source `a3a7f9203f925d42a8bafc617e656b1995e003bd`, run `34170036879`, job `101888444958`, artifact `10037000615` (`sha256:03cc22112a8862b93f48c8fc04fa8d8b43d8b41fcc8cddb2dc5c586eb9579ad6`) proved T26-059 automatic discovery but stopped at its two validation-boundary compile defects, now repaired. Final gate requires a fresh exact-SHA automatic run including Kentridge full-run, WorldBuilder T26-059 and normal Kentridge integration, plus T26-043's external multiplayer evidence.
