...
- [ ] **T26-043 — Verify shared multiplayer progression/outcome.** **BLOCKED external prerequisite:** System25 remains open on current master. Its branch `fixes/agent-7` is at `a51ab45d4106c4e0621b2f3df4ba3937c405a8d8` and explicitly remains blocked on System24. System24 is also still open; `fixes/agent-2` is at `c14d85b907b50608c7fc80eaa08f1d96123df2b3`, with representative gameplay, save/continue, shared-harness, read-only diagnostic T24-032, exact built-player, and closure tasks unchecked. Reuse System25 infrastructure only after those production prerequisites land; do not create an alternate transport/process harness.
- [ ] **T26-044 — Add canonical built-player full-run scenario.** **BLOCKED external prerequisite:** current Kentridge physical planner intentionally accepts one Kentridge region, while `20260829-020634-000-KentridgeMacroWorldPhysicalRealization` remains open. Its current branch `c97226ae01e3e2c42a6a3a7aa63de39c271c6856` confirms the separately owned GPU renderer publication/restoration prerequisite is still product-red. Do not weaken the single-region invariant or fake later regions.
...
- [ ] **T26-053 — Run automatic domain/campaign tests plus built-player full-run gate.** Campaign/fresh-graph regressions passed run `33941421358`; Story-owned validation passed run `33942377377`; latest exact-SHA request `57a0b1f00615d0901e2d25ee0d2216296b13f163` is parented directly by feature SHA `86911d9dec109c588310754f28c7a5644aed687a`, and run `33944532957` passed repository-derived automatic module validation. Built-player full-run and shared multiplayer portions remain blocked by T26-043/T26-044.
