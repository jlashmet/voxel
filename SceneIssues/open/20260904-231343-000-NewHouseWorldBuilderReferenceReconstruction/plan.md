...
Current `origin/master` (`af61066de669431a6555e737887bd5d4031525b8`) still carries the production GPU missing-surface defect tracked by `SceneIssues/open/20260902-171853-000-GpuRendererProductionRestoration`. Its latest exact run `33964990594` on renderer feature `7b5cc25052bf37b0ff40515bfe5a0fef2a8398e1` remains red after the byte-address generation-table attempt: the focused diagnostic still reads desired generation `0` instead of `10000`, and the production multi-chunk oracle still diverges at page-allocation/current-generation ownership (`2` vs `0`). Per `feature-readme.md`, do not substitute CPU/test-only rendering or another house-scoped speculative fix. Keep this feature open and resume visual acceptance when the renderer restoration reaches master.

Current feature head before this refresh: `9010b277b825cdf7bc779b45e1cee58afea061da`.
