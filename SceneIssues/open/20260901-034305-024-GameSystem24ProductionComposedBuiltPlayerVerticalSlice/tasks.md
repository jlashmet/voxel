...
**Validation history:** Compilation/binding defects and the unrelated Structures fixture were corrected. Runs `34000242054`, `34001710667`, `34004591329`, and `34006180411` passed editor validation but failed canonical `MoveToDestination`. Exact request `08274cda34b900a5bfe22a0a890f0306a42dddbc` / run `34008004416` was terminal **cancelled** and therefore proves no acceptance checkbox. Its artifact is diagnostic: the owned opening-control player received physical Input System movement and reached `HasExitedPub`; canonical System24 then stalled post-exit at roughly `(101.2,22.0,55.9)`, about 10.9 m from the destination NPC. The selected correction routes ordinary player input through the destination NPC's generated WorldBuilder network approach and architecture-projected public entrance before the NPC. Vitality persistence is also implemented but awaits a successful exact terminal gate. Current master `356b2e0e4d2818901c73bbc6b1788f8d6850356d` is integrated by `6d1357f572f4ba48a4bf7d3278101dd2235913f6`.
