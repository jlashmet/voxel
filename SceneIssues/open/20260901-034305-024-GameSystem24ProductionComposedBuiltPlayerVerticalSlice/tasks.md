...
**Validation history:** System 23 Application and current master are integrated. Runs `33984774287`, `33988814815` and `33995706164` exposed compilation/binding defects, now corrected. Run `33997426174` compiled but exposed the upstream Structures legacy-input fixture defect; master integration `36ecce581846fe6b0e1c021f9980890c279ad3e4` supplied its existing fix. Runs `34000242054` (product `b0b1e75ba97696a83bc0d2a5658e3fe28e22022f`) and `34001710667` (product `14551b3475a0c96d340f647b48d8692022a5749f`) passed editor validation but timed out in built-player MoveToDestination after different steering approaches. The latter logged control at `(111.5,32.1,82.8)` and ultimately failed at `(101.2,22.0,55.9)`. Code ordering exposes a premature-control window; the product now requires `_openingGameplayReleased`. Its causal sufficiency for the movement failure is not yet proven. Historical doorway test code does not prove traversal of the current generated world. T24-038 isolates the handoff/input/movement invariant before further route fixes.

**Active request:** `7db111ceb16816ae3d480160c3229d8e5b0ec5c5`, run `34004591329`, validates product `bcb317a986661265aee5ade5155bdf0f523e54bd` and is running. Do not replace or cancel it. Regression additions made after that product SHA require later exact-SHA validation. No remaining acceptance checkbox is completed by source inspection alone.
