...
- [ ] **T24-036 — Prove corrected product compilation on exact SHA.** Runs `33997426174` and `34000242054` prove System24 compiles, and `34000242054` passes the persistent EditMode/PlayMode phase before the assembled Kentridge route failure. Replacement exact-SHA CI must pass repository-owned module/player validation end to end before this task is complete.
