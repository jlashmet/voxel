...
- [x] Fetch/merge current master through `ebdc2e4f63ef73153cd4e0ff5c62efe604f35470` into feature head via `46b4e473ab6497d836053a072f3fe7050156756b`; current master remained unchanged at the 2026-08-30 16:43 PDT blocker re-check.
...
- [ ] Use `ci-test/fixes/agent-7` only for the final targeted-CI request; re-verified idle/stale at the prior observed head `8cc6ff94dcbbca46b1c522d08752235b891b1851`; do not publish until the typed-socket prerequisite lands and the feature tree is final.
