...
- [ ] Reframe the existing structural audit captures to include useful player-height seam views and establishing context for all four proofs; keep validation in the existing harness rather than create a parallel capture path.
