...
- [ ] Align the cliff ramp top and upper-platform walking surface by lowering the upper-platform attachment 8 voxels; preserve its stable socket ID/support contract and do not change global ramp or `CharacterMotor` semantics.
