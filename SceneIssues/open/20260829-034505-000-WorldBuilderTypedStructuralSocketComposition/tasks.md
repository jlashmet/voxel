...
- [ ] Move the cliff traversal endpoint onto the clear upper-platform landing before the house footprint so the existing production `CharacterMotor` can complete the authored vertical route without changing motor tolerance or structural semantics.
