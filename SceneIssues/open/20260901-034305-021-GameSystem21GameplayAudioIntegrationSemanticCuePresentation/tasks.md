...
- [ ] **T21-016 — Bind user volume/preferences.** IMPLEMENTED / VALIDATION PENDING: System23 landed on master at `68171d79250ab4ec44c9581df4dd827e8b5b3d92` with canonical `UserPreferences`, `IUserPreferencesStore`, and `IAudioPreferencesSink`. `AudioUserPreferencesSink` now maps Application-owned `MasterVolume` into `AudioPresentationRuntime.ApplyMasterVolume`, preserving Audio-owned SFX/music/ambience/voice gains. Focused EditMode coverage and Audio module-player proof now exercise that real seam; check this item after the integrated exact-SHA gate is green.
...
- [ ] **T21-032 — Close with isolation proof.** Current master `68171d79250ab4ec44c9581df4dd827e8b5b3d92` is merged into the feature at `337c9620cf7bc9937b8cb86e13d1e79bf3a3e052`; System23 preference integration is implemented after that merge. Run a new exact-SHA targeted CI request for the final integrated production head, then check T21-016/T21-032 only on green before closure.
