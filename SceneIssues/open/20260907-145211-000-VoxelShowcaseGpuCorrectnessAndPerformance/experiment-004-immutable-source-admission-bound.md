...
Coordinator-carried request `d13626286067b1cd6c13ddbeb4e65b28d43038f4` / source `da8e1284b1e3958ad579f5c4001ca8e9ccc139ea`, run `34168045938`, was already queued before `c10a7471` landed. It was left untouched until completion as required, then failed the same stale source with `CS0103` for `VoxelReadGrid` before any behavioral test/player could run. This is a product compile failure of the old source, not acceptance evidence and not an infrastructure retry case; the feature branch already contains the narrow import repair.
