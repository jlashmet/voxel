...
- [ ] **TGPU-006 — Stop speculative fixes after repeated failure.** If two materially different fixes hit the same parity symptom, isolate a minimal shader/buffer repro or proven root cause before another production change. No production fixes have been attempted yet; the guard remains active.
