...
Visual attribution: H1 (far terrain) is falsified as direct source:180s disable diagnostic retains150s obstruction. H2 (semantic proxies) is supported:180s semantic-only disable diagnostic clears120s/150s views with terrain active. Both exit0/12 captures; excluded from acceptance. Full-content180s trace passed12 captures;150s obstruction returns. Mountain CC9F50C170E9C507 is retained, but four-entry logging truncates150s ownership. Next log nearest camera-ray/proxy intersections to distinguish malformed geometry, transform/submission error and conservative handoff. G11 still needs bounded retired worlds and actual last-draw completion.
