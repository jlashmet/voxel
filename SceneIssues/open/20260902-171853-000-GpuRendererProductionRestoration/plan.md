...
Visual cause proven: submitted-mesh ray trace hits E6C05222E216258F at0.489m during150s obstruction. Canonical inspection identifies PaintSurface-only box bounds(832,220,192)–(863,244,223);140s obstruction is another PaintSurface-only bake. GeometryFor returns null, yet the adapter emitted an instance invoking the renderer's fallback box. Paint volumes do not create occupancy. Adapter now omits standalone instances without additive geometry while retaining canonical source/modifier application. Three new modifier regressions fail before/pass after; all5 cache/selection checks pass. Normal180s Showcase passed12 captures;150s phantom walls are gone. Composition-owned28s player passed7 captures/110 solids/1371 modifier sources; camera-tag setup defect was corrected. Far art remains blockout quality. G11 still needs bounded retired worlds and actual last-draw completion.
