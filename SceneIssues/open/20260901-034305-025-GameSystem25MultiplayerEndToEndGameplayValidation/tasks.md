...
- [ ] **T25-010A — Complete Application's production joined-party startup.** Required by T25-010/011: Sessions Start is leader-only, but Application previously never observed an active party while a joined client was in FrontEnd. Implemented in `8b95feaf7d849bc6a37b4d5a40a4e84b7e8c331a`: matching session/local-member projection, one local orchestration startup, no client Start or readiness grant, failure retry suppression and leave/rejoin reset. Added 17 authored NUnit cases plus owning Application frontend player assertions. **Validation pending:** request `920f0e4e4883d2c8abaf77877c1f8e55c8cd4df3`, run `34002524305`, job `101403824713` was queued at last inspection. Do not replace while queued/running. Keep unchecked until behavioral and module-player gates pass. This prerequisite does not replace separate-process topology evidence.
