...
- [ ] **T25-051 — Verify automatic validation selection.** Module/dependency ownership selects relevant EditMode/PlayMode tests and top-level multiplayer scenario; agents do not enumerate individual tests. Discovery path is confirmed; final module-local target still awaits System24 production composition.
