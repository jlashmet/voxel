...
- [x] **T25-010A — Complete Application's production joined-party startup.** Initial source `8b95feaf7d849bc6a37b4d5a40a4e84b7e8c331a` passed preserved request `920f0e4e4883d2c8abaf77877c1f8e55c8cd4df3`, run `34002524305`. The later correction is proven at exact source `f678a5f7e44a6d6e9366316d006d25bd7ebe27b8` by request `0078199d98f3cefe1508ae7331b23ad001b754f7`, run `34005489004`, job `101411770518`: owned Application/Kentridge/Net tests and player validations plus Kentridge integration passed. Active plus matching connected/gameplay-ready membership precedes one local graph startup; clients do not request Start/readiness; failure retry suppression and leave/rejoin reset are covered. Boundary checks are not separate-process topology evidence.
- [x] **T25-010B — Carry session admission through production UTP.** Framing source `e3ea06d7589c0a2d13a53962a6ebccbf67489e5b`; canonical authority correction `f678a5f7e44a6d6e9366316d006d25bd7ebe27b8`, proven by exact request `0078199d98f3cefe1508ae7331b23ad001b754f7`, run `34005489004`, job `101411770518`. Request/reply packets retain the 1,200-byte EVENT ceiling and exact direction/length checks. Canonical `AuthoritativeServerSession` consumes admission through its bounded `ServerCommandInbox` at the authoritative tick; copied payloads share gameplay queue limits; disconnected senders are removed; replies use the authority's existing network. Net does not grant membership/readiness. Owned `Assets/VoxelEngine/Net/Validation/SessionAdmissionTransportValidation.unity` and scenario use the real authority root, Storage and Edits. This is transport-only proof, not Sessions/provider admission or full multiplayer acceptance.
- [x] **T25-010C — Await real provider admission without fabricating identity.** `Assets/Game/Sessions/Api` exposes an optional nonblocking, request-local cancellable formation operation and `Assets/Game/Application` integrates it without changing synchronous providers. Before matching terminal authority success, no party member or gameplay graph is exposed; overlapping operations are blocked; Leave/Quit/Dispose cancel; stale completions are ignored; invalid identity/wrong-session/null/throwing providers fail closed. Exact source `12a33443e6fd94c30bce50d234eae2697e836a15`, request `81d5c60fd3844695f9932c40452dbb2fa13b29b9`, run `34011275001`, job `101427436345` passed all 13 automatically selected EditMode assemblies and 10 selected player validations, including owned Application lifecycle proof. Artifact `single-test-34011275001` digest `sha256:4c637383d851f84dab5b382ec1e2831cb5373afbb145377ed2eb46795fd6fcf8`. Boundary proof does not replace separate-process topology acceptance.
- [x] **T25-010D — Preserve live identity through network admission rejection and retry.** Sessions preflights member/connection ownership, publishes a binding only after Net succeeds, rejects live replacement before disconnect, preserves readiness on same-connection retry, and canonical `AuthoritativeServerSession` performs idempotent same-connection/player admission while rejecting identity collisions. The prior `CS0012` affected-test reference failure is resolved. Exact source `12a33443e6fd94c30bce50d234eae2697e836a15`, request `81d5c60fd3844695f9932c40452dbb2fa13b29b9`, run `34011275001`, job `101427436345` passed Sessions/Net owned regressions and player scenes as part of the 13 EditMode + 10 player automatic plan. Artifact digest `sha256:4c637383d851f84dab5b382ec1e2831cb5373afbb145377ed2eb46795fd6fcf8`. These focused proofs do not replace provider or separate-process gameplay acceptance.
...
- [x] **T25-051 — Verify automatic validation selection.** Exact source `6fedf1e54c2690cc88a17dc9b62b0fc0c0e46bf3`, request `c11b769f1ae25c29ad43305a97d4dbfcbf315991`, run `34178744571` repository-derived plan automatically selected both `KentridgeMultiplayerTopologyValidation` and structural release `KentridgeMultiplayerCapacityJipRehostValidation` plus owning module/player/integration targets; no manual enumeration was used. The run later failed compilation before player execution, which does not invalidate selection evidence.
