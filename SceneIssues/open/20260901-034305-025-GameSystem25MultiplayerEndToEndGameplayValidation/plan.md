...
- **External prerequisite:** System24 remains unmerged. Its exact feature `f6b3ace316f7122b48135ea04c0f04078049d9a5`, request `64296df9f805d2690942d5f302e07a32f3a8b823`, run `33984774287` reached the real validator but failed during automatic module validation with three Kentridge composition compile errors: missing `Game.Combat` assembly access, ambiguous `GameSessionSnapshot`, and unresolved `KentridgeSessionRuntimeGraph`. System25 must not copy, repair, or substitute that unmerged production composition/diagnostic boundary.
...
**Current branch:** this commit is the stable current-head exact-SHA candidate for T25-009 plus Scene25 evidence bookkeeping. Create the CI transport request with this exact feature commit as its sole parent, then leave it unchanged while queued/running.
