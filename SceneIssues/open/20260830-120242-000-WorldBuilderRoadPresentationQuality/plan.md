...
## Remaining gates
Run the broader road production regressions on the new exact documentation head through `ci-test/fixes/agent-3`, preserving automatic module/player validation. Then inspect durable full-resolution exact player evidence for curve/diagonal edge, both uneven shoulders, a real junction, non-flat cross-section, medium/far continuity, vegetation recovery, CharacterMotor traversal, and the former in-town frontage overlap; current generic SceneIssue capture is insufficient for that visual gate. Current master `2edf4c2e151492f67c4a1c1b846a9b7948284aba` is incorporated by merge `2bcecfc5c57f9c9007a364a3d7509674487de48b`; re-fetch before final promotion and revalidate if master advances again.
