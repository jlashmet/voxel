...
System 03 Characters API prerequisite is **resolved**: `Game.Characters.Api.CharacterId` landed on `origin/master` `e98191876c104ff115a1828b1ce0a6b2d4d4480b` and was merged into `fixes/agent-9` at `ccce1ff19c1306a838a2e5fadcf023399cc1d6b3`. Combat may consume Vitality API; Vitality never depends on Combat.
...
Migrate current Combat health authority, repository-wide duplicate-state cleanup, final boundary audit/ownership proof, then exact-SHA targeted/module validation CI. No respawn/revive policy, UI bars, game-over rules, or Combat-team semantics.
