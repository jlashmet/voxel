...
## Bypass / interaction / discovery regressions
...
- [ ] Exact-head targeted CI after production-boundary cleanup.
...
- [x] Current production diff is limited to reusable WorldBuilder planning/runtime, cave composition adapter, focused tests, and this SceneIssue; showcase-local/primitive validation drift has been removed.
