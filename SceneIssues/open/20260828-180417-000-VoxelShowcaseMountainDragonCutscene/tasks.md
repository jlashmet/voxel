...
- [ ] Run Experiment 027 `CurrentProductionRealizedStallFootprintSerializesForCollisionIsolation` on the exact current feature SHA through only `ci-test/fixes/agent-4`; do not replace a queued/running request.
