...
- [ ] Preserve an exposed shell-hugging ascent: each walking lane must overlap the natural mountain flank enough to read as a cut terrace, but must not sit wholly outside the core as a freestanding causeway or wholly inside it as a trench/tunnel; validate this envelope at both low and high ends of every tier.
