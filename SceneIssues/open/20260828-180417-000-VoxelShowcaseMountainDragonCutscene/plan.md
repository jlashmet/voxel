...
## Remaining gates
1. Run Experiment 027 on the exact current feature SHA through only `ci-test/fixes/agent-4`; use the realized top-solid/material output to distinguish a shared realization defect from scene-specific or non-voxel collision.
