...
## Blast radius / cost
CI/orchestration, validation assets, tests, docs, and one composition-assembly reference only; no authoritative gameplay runtime behavior changed. Earlier automatic Water + Kentridge validation measured 167.71 seconds. The latest green automatic flow remains routine-scale; the current repair is confined to Water validation composition and uses existing production rendering/composition APIs.

## Current commit
Material composition boundary checkpoint: `96a1fa288d102fe8c12998cbad870db6fbc83812`
