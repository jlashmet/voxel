...
- Live-tree inventory then found the remaining obsolete registrations; Structures' manifest had already disappeared on the live branch, the remaining interactables manifest was deleted, and current feature tree `b6344668d8b904e488f22cdc66eb15702e376874` has zero `*.module-validation.json` files.
...
## Remaining gates
- [ ] Reconcile checklist items with the implemented module-owned assembly migration and convention regressions.
