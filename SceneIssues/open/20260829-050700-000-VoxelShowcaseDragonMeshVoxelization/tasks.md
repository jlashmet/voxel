...
- [ ] Vendor the deterministic OBJ source/reconstructable archive into this repository without changing geometry. Runs `33362323833` and `33364246307` isolated first a wrong segmented `part13` payload and then a mixed whole+segmented transport failure. Commit `ccd8fccd` leaves canonical logical `part00`-`part15` with corrected whole `part13` only. The reconstruction adapter/test pin gzip SHA-256 `fd2f8253fcf5bc32b275640448511f59d20dcc7d01c307f99124b224431892d4`, OBJ SHA-256 `f1f44d59f7d9c775b600ac0b9ad066a15a3c652bf685a12b2344b8c383ff12b1`, and 860,349 bytes; keep unchecked until exact-source execution proves reconstruction.
