...
- [ ] Run the phase-9 exhausted-budget completion-consumption regression plus the production GPU relocation/liveness regression on the next exact feature source through `ci-test/fixes/agent-6`.
