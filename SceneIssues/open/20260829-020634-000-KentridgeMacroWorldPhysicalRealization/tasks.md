...
- [x] Pin the active fail-before request without replacement: `ci-test/fixes/agent-1=6ddc72724c6653538be5c5a9818ebee059726264`, parent/source `da3f5be338c57f5fe99ad4324405422e78c3918e`, run `33999899224` is `in_progress`. Automatic module validation has completed failure, consistent with the intended fail-before discriminator; the standalone SceneIssue replay is still running. Do not replace or interfere while running.
