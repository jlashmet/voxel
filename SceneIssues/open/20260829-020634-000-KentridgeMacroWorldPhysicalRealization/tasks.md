...
- [ ] Prioritize workers holding phase-2 paged GPU results ahead of ordinary worker polling under the existing solid deadline, preserving cursor fairness, build ceilings, streaming radius, and all acceptance budgets; add a focused behavioral ordering regression.
