...
- [x] Re-fetch publication refs: `origin/master=3654c13f72ed157c53b340443a766795d772f596` now contains PR #306, which closed the shared SmallVoxelShowcase Input System restoration. Renderer owner is `fixes/agent-1=1c2720f54268054d90ac50f1a15999126bcc3c35`, rebuilt from then-current `a180749ed7c00d28bed6661fc9a3da4c9a9b61fc`; transport `3fc980e8757cff92e891a68b3f3235605eca3cc5` has that source as parent and run `33991474823` is in progress. Leave the active request untouched; its source predates master `3654c13...`, and no validated GPU renderer correction is on master yet.
...
- [ ] After Agent 1 completes exact validation, resolves any remaining CPU visual/renderer defects, and merges the validated renderer/shared-presentation correction to `master`, merge then-current `origin/master` into `fixes/agent-6` per `master-sync-required.md` and re-evaluate strict opening/publication convergence.
