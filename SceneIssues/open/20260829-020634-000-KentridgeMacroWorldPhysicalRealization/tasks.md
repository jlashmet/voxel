...
- [ ] Prove the endpoint-gate/settlement-approach mismatch with a minimal independent generic-settlement fixture before changing shared planner behavior.
- [ ] Repair only the demonstrated shared planner endpoint-validation defect, preserving strict-by-default route policy and Kentridge-only semantic opt-in.
