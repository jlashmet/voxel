...
- [x] Re-fetch publication refs on 2026-09-05: `origin/master=a180749ed7c00d28bed6661fc9a3da4c9a9b61fc`; renderer owner is now `fixes/agent-1=2008e51fc070228757ec5c7aa33d69ba50c805ce`; its shared far-feature presentation correction remains unmerged.
- [x] Classify renderer-owner exact run `33986630571` on source `7ceaa0120a4e30c260b1f383e7fc973c3c205309`: product/test compile failure before validation because `FarFeaturePresentationParityTests.cs` could not resolve `VoxelEngine.Rendering.Api`; Agent 1 fixed the missing test-assembly reference in `b971001b642f7b763aa0d42e585f4784e80cea9e`.
- [x] Recheck renderer-owner replacement exact request only after that fix: transport `070458aabe4773975ecb4d2714dc473a3d7f1575` has parent/current source `2008e51fc070228757ec5c7aa33d69ba50c805ce`; run `33987770257` is queued and must not be replaced or interfered with.
