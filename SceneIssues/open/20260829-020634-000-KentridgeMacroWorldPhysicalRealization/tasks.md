...
- [x] Re-fetch publication refs on 2026-09-05: `origin/master=a180749ed7c00d28bed6661fc9a3da4c9a9b61fc`; renderer owner is `fixes/agent-1=7ceaa0120a4e30c260b1f383e7fc973c3c205309`; its shared far-feature presentation correction remains unmerged.
- [x] Recheck renderer-owner exact request `33986630571`: transport `416400b334fbac3561a6e790723d99328954e12e` has parent `7ceaa0120a4e30c260b1f383e7fc973c3c205309`, so it is exact for the current renderer-owner head; it remains queued and must not be replaced or interfered with. Prior request `33984671790` was cancelled while queued and is infrastructure-only.
