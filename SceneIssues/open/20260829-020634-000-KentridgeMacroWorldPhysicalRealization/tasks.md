...
- [ ] Validate `PlayableProductionPlanningLeavesMacroSelectionForGeometryCatalogueBuild` on the sole CI transport. If red, use the assertion as the minimal repro before any product fix; if green, isolate final catalogue combine/configure transfer.
