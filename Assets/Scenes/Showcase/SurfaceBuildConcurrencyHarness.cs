...
namespace VoxelEngine.Showcase
{
    ...
    /// value and preserves the production converged ceiling at zero.
    /// </summary>
    public static class SurfaceBuildConcurrencyHarness
    {
        ...
        private static void Apply()
        {
            ...
            RenderingComposition.SetVoxelBuildConcurrency(converging, 0);
            Debug.Log($"HARNESS build concurrency converging={converging} converged=0");
        }
