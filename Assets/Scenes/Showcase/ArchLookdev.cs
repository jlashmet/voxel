    ...
    public sealed class ArchLookdev : MonoBehaviour
    {
        ...
        private void ApplyPresentation()
        {
            ...
            VoxelPresentationCatalogue.MaterialAlbedo[StoneMaterial] = new Vector4(
                stone.r, stone.g, stone.b, 1f);
            Color moss = Color.HSVToRGB(_mossHue, _mossSaturation, _mossValue);
            VoxelPresentationCatalogue.CoatingTint[Coatings.Moss] = new Vector4(
                moss.r, moss.g, moss.b, 1f);
            float azimuth = _sunAzimuth * Mathf.Deg2Rad;
            float elevation = _sunElevation * Mathf.Deg2Rad;
            VoxelRenderBridge.SunDirection = new Vector3(
        ...
        private void OnGUI()
        {
            ...
            GUILayout.Label(((ArchRuinDamage)_damage).ToString(), _valueStyle);
        ...
        private void LoadTargetImage()
        {
            ...
            string[] candidates =
            {
                ...
                Path.Combine(Directory.GetParent(Application.dataPath).FullName,
                             "Artifacts", "ArchLookdev", "target.png"),
            };
            foreach (string candidate in candidates)
            {
                ...
                _targetImage = new Texture2D(2, 2, TextureFormat.RGBA32, false)
                    { name = "Sunlit Cleric Reference", hideFlags = HideFlags.DontSave };
        ...
        private IEnumerator WaitForSurface()
        {
            ...
            {
                VoxelSurfaceMetrics metrics = VoxelRenderBridge.SurfaceMetrics;
                bool ready = metrics.SolidKnownChunks > 0 && metrics.SolidDirtyChunks == 0
                    && metrics.SolidResidentChunks >= metrics.SolidKnownChunks;
            ...
            if (stable < 3)
            {
                ...
                throw new InvalidOperationException(
                    $"Surface did not converge: known={metrics.SolidKnownChunks}, "
