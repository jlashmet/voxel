...
{
    /// <summary>
    /// Minimal presentation shell shared by the lightweight subsystem showcases. It is created
    /// only in play mode so the scenes stay tiny and the PlayMode tests avoid the full voxel world.
    /// </summary>
