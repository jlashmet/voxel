...
namespace Game.Composition.Campaign.Runtime
{
    public sealed class CampaignRuntime : IStoryStateView, IStoryEffectSink
    {
        ...
        public CampaignRuntime(CampaignBlueprint blueprint, IReadOnlyList<CutsceneStageRealization> stages, IWorldBoundCutsceneActorProvider actorProvider, ICutscenePresentation presentation, IReadOnlyList<QuestDefinition> questDefinitions = null)
        {
        ...
        public bool IsObjectiveActive(ObjectiveRef objective) => _activeObjectives.Contains(objective);
        public bool IsObjectiveCompleted(ObjectiveRef objective) => _completedObjectives.Contains(objective);
        ...
        private void StartObjective(ObjectiveRef objective)
        {
            ...
            if (_completedObjectives.Contains(objective)) throw new InvalidOperationException("Story attempted to restart completed objective '" + objective + "'.");
