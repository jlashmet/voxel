...
namespace VoxelEngine.Showcase
{
    ...
    public sealed partial class ShowcaseWorld
    {
        ...
        private void AuthorCastlePresentation(int3 origin)
        {
            ...
            int[] towerXs = { 20, 74, 706, 760 };
            for (int i = 0; i < towerXs.Length; i++)
            {
                int z = i < 2 ? 36 : 76;
                crown.Box(new int3(towerXs[i], 146, z), new int3(18, 20, 18), detail);
                crown.Box(new int3(towerXs[i], 146, z + 50), new int3(18, 20, 18), detail);
            }
        ...
        private void AuthorCliffPresentation(CliffSite site)
        {
            ...
            int lowerX = 20;
            int lowerZ = 20;
            writer.Box(new int3(lowerX, 12, lowerZ), new int3(180, 6, 8), GameMaterialIds.DarkStone)
            ...
            for (int zi = 0; zi < supportZ.Length; zi++)
            {
                ...
                writer.Box(new int3(supportX[xi] - contextOrigin.x - 8, bottom,
                        supportZ[zi] - contextOrigin.z - 8),
                    new int3(16, height, 16), stone);
            }
        ...
        private void AuthorFacadePresentation(int3 firstOrigin)
        {
            ...
            AuthorPresentationCatalogue(
                "facade-roof-production-detail", origin, new int3(540, 240, 170),
                0x53544631u,
                StructuralSocketRole.Building | StructuralSocketRole.Facade | StructuralSocketRole.Roof,
                FacadeTag | RoofTag, writer, 64, GameMaterialIds.MasonryMedium);
        }
