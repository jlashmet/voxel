...
namespace Game.Vitality.Api
{
    public readonly struct VitalitySnapshot : IEquatable<VitalitySnapshot>
    {
        ...
        public bool Defeated => IsDefeated;
        public ulong Revision { get; }

        public VitalitySnapshot(CharacterId characterId, int current, int maximum, bool isDefeated)
            : this(characterId, current, maximum, isDefeated, 0UL)
        {
        }

        public VitalitySnapshot(CharacterId characterId, int current, int maximum, bool isDefeated, ulong revision)
        {
        ...
        public override int GetHashCode() => HashCode.Combine(CharacterId, Current, Maximum, IsDefeated, Revision);
