...
namespace Game.Structures.Api
{
    ...
    /// <summary>
    /// Compatibility mapping for the existing castle showcase. Values deliberately reproduce the
    /// current dimensions/cadences; later castle presets can build different component bundles
    /// without adding another private geometry framework.
    /// </summary>
