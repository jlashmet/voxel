...
namespace Game.Structures.Api
{
    ...
    /// downstream basement/dungeon/crypt composition may attach without exposing the authored room
    /// implementation or requiring consumers to re-derive castle-private coordinates.
    /// </summary>
    ...
    {
        /// <summary>
        /// Maps the historical cellar and deep dungeon coordinates exactly and adds a bounded
        /// gatehouse crypt extension point below the existing gatehouse without authoring a new room.
        /// </summary>
