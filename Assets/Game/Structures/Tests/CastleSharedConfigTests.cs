...
namespace Game.Structures.Tests
{
    public sealed class CastleSharedConfigTests
    {
        ...
        public void CompatibilityProjectionPreservesLegacyPlanDimensions()
        {
            ...
            CastleSharedConfig config = CastleCompatibilityPreset.FromPlan(in plan);
        ...
        public void CompatibilityProjectionIsPureForSamePlan()
        {
            ...
            CastleSharedConfig a = CastleCompatibilityPreset.FromPlan(in plan);
            CastleSharedConfig b = CastleCompatibilityPreset.FromPlan(in plan);
