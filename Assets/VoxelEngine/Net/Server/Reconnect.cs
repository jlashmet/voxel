...
namespace VoxelEngine.Net.Server
{
    ...
    public static class Reconnect
    {
        ...
        /// <summary>Full region payload estimate: 64^3 bricks × 1 byte per brick ≈ 262 KB.</summary>
        private const int k_FullRegionEstimateBytes = VoxelEngine.Core.Storage.VoxelDimensions.BricksPerRegion;
