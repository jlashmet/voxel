            ...
            switch (species)
            {
                case TreeSpecies.Pine:
                    return new TreeSpeciesProfile
                    {
                        ...
                        BranchStart = 0.20f, BranchAngleMin = 58f, BranchAngleMax = 72f,
                        BranchLengthFactor = 0.30f, BranchLengthDecay = 0.55f,
                        BranchRadiusDecay = 0.48f, UpwardBias = 0.13f, Droop = 0.09f,
                        Gnarliness = 0.045f,
                ...
                case TreeSpecies.Birch:
                    return new TreeSpeciesProfile
                    {
                        ...
                        BranchStart = 0.32f, BranchAngleMin = 34f, BranchAngleMax = 52f,
                        BranchLengthFactor = 0.29f, BranchLengthDecay = 0.58f,
                        BranchRadiusDecay = 0.46f, UpwardBias = 0.26f, Droop = 0.05f,
                        Gnarliness = 0.085f,
                ...
                case TreeSpecies.Maple:
                    return new TreeSpeciesProfile
                    {
                        ...
                        BranchStart = 0.25f, BranchAngleMin = 42f, BranchAngleMax = 58f,
                        BranchLengthFactor = 0.34f, BranchLengthDecay = 0.58f,
                        BranchRadiusDecay = 0.48f, UpwardBias = 0.20f, Droop = 0.08f,
                        Gnarliness = 0.13f,
                ...
                case TreeSpecies.Willow:
                    return new TreeSpeciesProfile
                    {
                        ...
                        BranchLevels = 3, PrimaryBranches = 9, ChildBranches = 3,
                        BranchStart = 0.20f, BranchAngleMin = 48f, BranchAngleMax = 62f,
                        BranchLengthFactor = 0.41f, BranchLengthDecay = 0.63f,
                        BranchRadiusDecay = 0.44f, UpwardBias = 0.10f, Droop = 0.40f,
                        Gnarliness = 0.15f,
                ...
                case TreeSpecies.Sakura:
                    return new TreeSpeciesProfile
                    {
                        // Japanese cherry remains broad and asymmetric, but no primary scaffold
                        // limb is close enough to horizontal for the crown to read as a fallen tree.
                        ...
                        BranchStart = 0.16f, BranchAngleMin = 48f, BranchAngleMax = 62f,
                        BranchLengthFactor = 0.43f, BranchLengthDecay = 0.61f,
                        BranchRadiusDecay = 0.47f, UpwardBias = 0.17f, Droop = 0.16f,
                        Gnarliness = 0.22f,
                ...
                case TreeSpecies.Dead:
                    return new TreeSpeciesProfile
                    {
                        ...
                        BranchStart = 0.22f, BranchAngleMin = 38f, BranchAngleMax = 60f,
                        BranchLengthFactor = 0.36f, BranchLengthDecay = 0.58f,
                        BranchRadiusDecay = 0.46f, UpwardBias = 0.15f, Droop = 0.18f,
                        Gnarliness = 0.30f,
                ...
                default:
                    return new TreeSpeciesProfile
                    {
                        ...
                        BranchLevels = 3, PrimaryBranches = 9, ChildBranches = 3,
                        BranchStart = 0.20f, BranchAngleMin = 44f, BranchAngleMax = 56f,
                        BranchLengthFactor = 0.36f, BranchLengthDecay = 0.60f,
                        BranchRadiusDecay = 0.49f, UpwardBias = 0.20f, Droop = 0.10f,
                        Gnarliness = 0.18f,
                        LeafStyle = TreeLeafStyle.Broad, LeavesPerTip = 11,
