...
namespace VoxelEngine.Structures.Api
{
    ...
    /// <summary>
    /// Pure world-space geometry for one planned secondary arched wall door. Runtime realization
    /// and application interaction consume the same row spans and depth footprint.
    /// </summary>
    public readonly struct CastleWallDoorGeometry
    {
        ...
        /// <summary>Player-facing interaction point eight voxels outside the door.</summary>
        ...
        /// <summary>
        /// Enumerates exactly the authored leaf footprint, including the deeper iron straps.
        /// Intended for infrequent authored interaction, not hot realization loops.
        /// </summary>
        ...
        public static bool TryGetArchRowSpan(
            int width,
            int height,
            int row,
            out int minOffset,
