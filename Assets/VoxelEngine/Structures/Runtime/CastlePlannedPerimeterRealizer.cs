...
{
    /// <summary>
    /// Realizes an already-planned castle curtain wall. Wall style, gate clearance policy, and
    /// perimeter coordinates are frozen before Runtime; this component owns only voxel geometry.
    /// </summary>
    internal static class CastlePlannedPerimeterRealizer
    {
        internal static void Walls(
        ...
        internal static void WallsWithExplicitGateClearance(
            ref VoxelBrush brush,
            in CastlePlan plan,
            int2[] localVertices,
            int gateEdgeIndex,
