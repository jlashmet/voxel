...
{
    /// <summary>
    /// Realizes keep-local movement geometry only: entrance, clear aisle, grand stair, and spiral
    /// stair. The castle plan supplies all dimensions; this component makes no room, facade,
    /// furnishing, topology, or randomness decisions.
    /// </summary>
