...
{
    /// <summary>
    /// Realizes a preplanned keep entrance and vertical-circulation layout. The caller supplies the
    /// actual world-space keep centre, so this component never knows about the legacy +Z anchor
    /// compatibility transform used by the older keep recipe.
    /// </summary>
