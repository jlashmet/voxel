...
{
    /// <summary>
    /// Compatibility realization for the historical south-facing keep circulation layout. New
    /// spatial castles consume CastleKeepCirculationPlan through CastleKeepCirculationRealizer;
    /// this component exists only so the legacy build path has no geometry embedded in its
    /// stage orchestrator while preserving its exact authored coordinates.
    /// </summary>
    internal static class CastleLegacyKeepCirculationRealizer
    {
