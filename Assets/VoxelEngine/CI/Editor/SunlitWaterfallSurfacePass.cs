                ...
                for (int i = 0; i < materials.Length; i++)
                {
                    ...
                    if (ContainsAny(key, "waterfall foam", "water foam", "foam"))
                    {
                        Configure(material, null,
                            ...
                            new Color(1f, 1f, 1f),
                            6f, 0.22f, 0f, 0.40f, 0.025f, 0f, 0.02f,
                            new Color(0.16f, 0.22f, 0.24f));
                    }
                    else if (ContainsAny(key, "waterfall", "cascade"))
                    {
                        Configure(material, null,
                            new Color(0.57f, 0.88f, 0.98f, 0.86f),
                            new Color(0.42f, 0.78f, 0.94f),
                            new Color(0.90f, 0.99f, 1.0f),
                            5f, 0.26f, 0f, 0.18f, 0.09f, 0f, 0.035f,
                            new Color(0.08f, 0.19f, 0.24f));
                    }
                    else if (ContainsAny(key, "water", "pool", "basin", "turquoise", "channel plane"))
                    {
                        Configure(material, null,
                            new Color(0.035f, 0.62f, 0.84f, 0.90f),
                            new Color(0.025f, 0.42f, 0.67f),
                            new Color(0.22f, 0.88f, 0.96f),
                            4f, 0.20f, 0f, 0.16f, 0.06f, 0.20f, 0.055f,
                            new Color(0.025f, 0.13f, 0.18f));
                    }
                    else if (ContainsAny(key, "cloud"))
                    {
                        Configure(material, null,
                            new Color(0.985f, 0.985f, 0.96f),
                            new Color(0.90f, 0.94f, 0.98f),
                            Color.white,
                            7f, 0.20f, 0f, 0.0f, 0.02f, 0f, 0.09f, Color.black);
                    }
                    ...
                    else if (ContainsAny(key, "ridge"))
                    {
                        Configure(material, rock,
                            ...
                            3f, 0.22f, 0.44f, 0.08f, 0.075f, 0.55f, 0.035f, Color.black);
                    }
                    else if (ContainsAny(key, "stone", "masonry", "ruin", "ashlar", "castle", "tower", "pillar", "lintel", "block"))
                    {
                        Configure(material, stone,
                            ...
                            2f, 0.32f, 0.72f, 0.10f, 0.11f, 0.30f, 0.055f, Color.black);
                    }
                    else if (ContainsAny(key, "rock", "cliff", "earth", "slope"))
                    {
                        ...
                        Configure(material, source,
                            ...
                            3f, 0.24f, 0.62f, 0.11f, 0.075f, 0.67f, 0.04f, Color.black);
                    }
                    else if (ContainsAny(key, "grass", "turf", "garden", "crown", "terrain patch"))
                    {
                        Configure(material, grass,
                            ...
                            1f, 0.30f, 0.62f, 0.10f, 0.085f, 0.72f, 0.04f, Color.black);
                    }
                    else if (ContainsAny(key, "moss", "leaf", "canopy", "bush"))
                    {
                        Configure(material, grass,
                            ...
                            1f, 0.34f, 0.50f, 0.13f, 0.11f, 0.45f, 0.055f, Color.black);
                    }
                    else if (ContainsAny(key, "bark", "trunk", "branch"))
                    {
                        Configure(material, wood,
                            ...
                            8f, 0.40f, 0.70f, 0.10f, 0.10f, 0.10f, 0.025f, Color.black);
                    }
                    else if (ContainsAny(key, "roof", "spire"))
                    {
                        Configure(material, slate,
                            ...
                            2f, 0.34f, 0.55f, 0.08f, 0.09f, 0.20f, 0.04f, Color.black);
                    }
                }
            }

            camera.backgroundColor = new Color(0.20f, 0.59f, 0.91f, 1f);
            RenderSettings.ambientMode = AmbientMode.Trilight;
            RenderSettings.ambientSkyColor = new Color(0.63f, 0.77f, 0.94f);
            RenderSettings.ambientEquatorColor = new Color(0.56f, 0.61f, 0.50f);
            RenderSettings.ambientGroundColor = new Color(0.24f, 0.28f, 0.18f);
            RenderSettings.ambientIntensity = 0.72f;
            RenderSettings.fog = true;
            RenderSettings.fogMode = FogMode.Linear;
            RenderSettings.fogColor = new Color(0.61f, 0.79f, 0.93f);
            RenderSettings.fogStartDistance = 27f;
            RenderSettings.fogEndDistance = 59f;
        }
